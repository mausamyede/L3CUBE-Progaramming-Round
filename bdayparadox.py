...
print("Probablity of two people out of 23 having same birthday: ",float(countpos)/float(countpos+countneg))
...
print("Probablity of two people out of 75 having same birthday: ",float(countpos)/float(countpos+countneg))
